...
${licenseURLs(data)}
![badge](https://img.shields.io/badge/license-${licenseURLs(badge)}-purple)
  ...
  ## License
  ${data.license}
  Further information on this license can be found at: https://choosealicense.com/licenses/${url}
